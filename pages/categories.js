...
import { fetchCategories, updateCategoryById, deleteCategoryById, insertCategory } from "@/utils/api";
      ...
      <form onSubmit={saveCategory}>
        <div className="flex gap-1">
          <input
            ...
            value={name}/>
          <select
          onChange={ev => setParentCategory(ev.target.value === "0" ? "0" : ev.target.value)}
